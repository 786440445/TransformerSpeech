...
from src.utils.utils import process_dict
from src.transformer.optimizer import TransformerOptimizer
from src.data.dataset import AudioDataset
from src.data.dataloader import AudioDataLoader
...
PATH = '../../'
parser.add_argument('--dict', type=str, default=PATH + 'tmp/train_chars.txt',
